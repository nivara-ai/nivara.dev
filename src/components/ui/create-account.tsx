        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onCreateAccount}>
              ...
              <div className="animate-element animate-delay-700 flex items-center text-sm">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <span className="text-foreground/90">I agree to the <span className="text-emerald-400">Terms of Service</span> and <span className="text-emerald-400">Privacy Policy</span></span>
                </label>
              </div>
            ...
            <div className="animate-element animate-delay-900 relative flex items-center justify-center">
              ...
              <span className="px-4 text-sm text-muted-foreground bg-background absolute">Or sign up with</span>
            </div>
